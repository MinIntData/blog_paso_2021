...
base_1921_dpto <- read_sf("data/base_chaco_2019_2021_depto.geojson")

base_1921_circuito <- read_sf("data/base_chaco_2019_2021_circuito.geojson") 
...
#### **Diagrama de transferencia de votos entre agrupaciones políticas y voto blanco para la Provincia de Chaco**

```{=html }
<div class="flourish-embed flourish-sankey" data-src="visualisation/7344553"><script src="https://public.flourish.studio/resources/embed.js"></script></div>
```
