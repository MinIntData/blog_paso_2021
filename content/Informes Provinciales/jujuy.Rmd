...
base_1921_dpto <- read_sf("data/base_jujuy_2019_2021_depto.geojson")

base_1921_circuito <- read_sf("data/base_jujuy_2019_2021_circuito.geojson") 
...
```{=html }
<div class="flourish-embed flourish-sankey" data-src="visualisation/7320638"style = "height: 860px; width: 1050px;"><script src="https://public.flourish.studio/resources/embed.js"></script></div>
```
...
```{=html }
<div class="flourish-embed flourish-scatter" data-src="visualisation/7334824"><script src="https://public.flourish.studio/resources/embed.js"></script></div>
...
#### -    Se observa cierta transversalidad del electorado de JxC, lo que respaldaría una transferencia de votos por parte del FdT. Jujuy es una de las pocas provincias donde JxC obtiene un apoyo electoral transversal (pensando en términos de nivel socioeconómico).


----------

```{=html }
<div class="flourish-embed flourish-scatter" data-src="visualisation/7334804"><script src="https://public.flourish.studio/resources/embed.js"></script></div>

```

---------

#### **Frente de Izquierda (FIT) y Nivel Socioeconómico**


#### -   Existe una marcada relación entre nivel socioeconómico y voto a la izquierda, algo opuesto a lo esperado (mayor apoyo en departamentos más ricos). 
...
<div class="flourish-embed flourish-scatter" data-src="visualisation/7334791"><script src="https://public.flourish.studio/resources/embed.js"></script></div>
```
...
#### -    Existe una fuerte relación entre proporción de hogares con NBI (menor nivel socioeconómico) y participación electoral.


----------

```{=html }
<div class="flourish-embed flourish-scatter" data-src="visualisation/7334782"><script src="https://public.flourish.studio/resources/embed.js"></script></div>
...
pal19fdt <- colorNumeric('Blues',reverse = FALSE ,domain = 19:61)
...
leaflet(base_1921_circuito) %>%
  addProviderTiles(providers$CartoDB.DarkMatterNoLabels) %>%
  addPolygons(popup = ~paste("Departamento: ", base_1921_circuito$nomdepto,
