...
base_1921_dpto <- read_sf("data/base_larioja_2019_2021_depto.geojson")
...
#### **Diagrama de transferencia de votos entre agrupaciones políticas y voto blanco para la Provincia de La Rioja**

 
```{=html }
<div class="flourish-embed flourish-sankey" data-src="visualisation/7408289"><script src="https://public.flourish.studio/resources/embed.js"></script></div>
```
