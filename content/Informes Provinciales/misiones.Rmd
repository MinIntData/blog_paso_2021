...
base_1921_dpto <- read_sf("data/base_misiones_2019_2021_depto.geojson")

base_1921_circuito <- read_sf("data/base_misiones_2019_2021_circuito.geojson")
...
#### **Diagrama de transferencia de votos entre agrupaciones políticas y voto blanco para la Provincia de Misiones**

 
```{=html }
<div class="flourish-embed flourish-sankey" data-src="visualisation/7388905"><script src="https://public.flourish.studio/resources/embed.js"></script></div>
```
...
#### **Diferencia de votos obtenidos por el FdT entre 2019 y 2021**.
...
pal21fdt <- colorNumeric('Blues',reverse = FALSE ,domain = 10:40)
...
paldif1921 <- colorNumeric("Reds",reverse = TRUE ,domain = base_1921_circuito$dif_FDT)
