...
base_1921_dpto <- read_sf("data/base_neuquen_2019_2021_depto.geojson")

base_1921_circuito <- read_sf("data/base_neuquen_2019_2021_circuito.geojson")
...
```{=html }
<div class="flourish-embed flourish-sankey" data-src="visualisation/7355743"><script src="https://public.flourish.studio/resources/embed.js"></script></div>
```
...
paldif1921 <- colorNumeric('Reds',reverse = FALSE ,domain = base_1921_dpto$dif_FDT)
