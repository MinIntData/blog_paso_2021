...
base_1921_dpto <- read_sf("data/base_sanluis_2019_2021_depto.geojson")

base_1921_circuito <- read_sf("data/base_sanluis_2019_2021_circuito.geojson") 
...
```{=html }
<div class="flourish-embed flourish-sankey" data-src="visualisation/7400225"><script src="https://public.flourish.studio/resources/embed.js"></script></div>
```
...
pal19fdt <- colorNumeric('Blues',reverse = FALSE ,domain = 20:90)
pal21fdt <- colorNumeric('Blues',reverse = FALSE ,domain = 20:90)
