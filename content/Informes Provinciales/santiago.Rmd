...
base_1921_dpto <- read_sf("data/base_santiago_2019_2021_depto.geojson")
...
#### **Diagrama de transferencia de votos entre agrupaciones políticas y voto blanco para la Provincia de Santiago del Estero**
...
pal19fdt <- colorNumeric('Blues',reverse = FALSE ,domain = 19:100)
pal21fdt <- colorNumeric('Blues',reverse = FALSE ,domain = 19:100)
