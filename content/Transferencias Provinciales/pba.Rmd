...
paldpto19fdt <- colorFactor('Blues',reverse = FALSE ,domain = base_pba1921$fdt_19)
paldpto21fdt <- colorFactor('Blues',reverse = FALSE ,domain = base_pba1921$fdt_21)
...
pal19fdt <- colorFactor('Blues',reverse = FALSE ,domain = base_pba1921_circuito$fdt_19)
pal21fdt <- colorFactor('Blues',reverse = FALSE ,domain = base_pba1921_circuito$fdt_21)
