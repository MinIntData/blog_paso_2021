...
read_sf("data/base_stafe_2019-2021_dpto.geojson")
...
pal19fdt <- colorQuantile('Blues',reverse = FALSE ,domain = base_stafe1921$fdt_19)
pal21fdt <- colorQuantile('Blues',reverse = FALSE ,domain = base_stafe1921$fdt_21)
